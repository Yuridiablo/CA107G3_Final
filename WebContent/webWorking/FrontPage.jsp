...
<head>
    ...
    <style type="text/css">
        .slider {
          background: url(images/ali-inay-9858-unsplash.jpg) no-repeat;
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="navbar navbar-expand-lg navbar-light">
                            <img src="images/SeeKFoodA.png" id="logo">
                        ...
                        <div class="row d-flex justify-content-center">
                                ...
                                <form class="form-wrap mt-4">
                                    ...
                                    <div class="tab-content" id="nav-tabContent">
                                        ...
                                        <div class="tab-pane fade show" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                                            <div class="input-group">
                                                <input type="text" class="form-control" placeholder="輸入會員暱稱.." aria-label="Recipient's username" aria-describedby="button-addon2">
                                                <div class="input-group-append">
                            ...
                            <div class="col-md-6 myad">
                                <div class="owl-carousel owl-theme">
                                    ...
                                    <div class="item">
                                        <h4>多久沒和姊妹淘一起聚餐？</h4>
                                        <img src="images/melissa-walker-horn-637092-unsplash.jpg">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="find-place-img_wrap">
                        <div class="grid">
                            <figure class="effect-ruby">
                                <img src="images/zachariah-hagy-484664-unsplash.jpg" class="img-fluid" alt="img13" id="hotp1" />
                                <figcaption>
                                    <h5>謝師宴。精選</h5>
                                    <p>6451席</p>
                                </figcaption>
                    ...
                    <div class="row find-img-align">
                        <div class="col-md-12">
                            <div class="find-place-img_wrap">
                                <div class="grid">
                                    <figure class="effect-ruby">
                                        <img src="images/melissa-walker-horn-637092-unsplash.jpg" class="img-fluid" id="hotp2" alt="img13" />
                                        <figcaption>
                                            <h5>本月話題</h5>
                                            <p>612席</p>
                                        </figcaption>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="find-place-img_wrap">
                                <div class="grid">
                                    <figure class="effect-ruby">
                                        <img src="images/jason-leung-537357-unsplash.jpg" class="img-fluid" id="hotp3" alt="img13" />
                                        <figcaption>
                                            <h5>日本料理</h5>
                                            <p>1249席</p>
                                        </figcaption>
                    ...
                    <div class="row find-img-align">
                        <div class="col-md-12">
                            <div class="find-place-img_wrap">
                                <div class="grid">
                                    <figure class="effect-ruby">
                                        <img src="images/sabri-tuzcu-182962-unsplash.jpg" class="img-fluid" id="hotp4" alt="img13" />
                                        <figcaption>
                                            <h5>女孩最愛</h5>
                                            <p>917席</p>
                                        </figcaption>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="find-place-img_wrap">
                                <div class="grid">
                                    <figure class="effect-ruby">
                                        <img src="images/photo2.jpg" class="img-fluid" id="hotp5" alt="img13" />
                                        <figcaption>
                                            <h5>健康樂活</h5>
                                            <p>242席</p>
                                        </figcaption>
            ...
            <div class="row">
                <div class="col-md-4 featured-responsive">
                    <div class="featured-place-wrap">
                        <a href="detail.html">
                            <img src="images/000J7RD0AACDCC23D13991j.jpg" class="img-fluid" alt="#">
                            ...
                            <div class="featured-title-box">
                                ...
                                <p><span>$$$</span>$$</p>
                                <div class="media">
                                    <img src="images/4809.jpg" class="align-self-start mr-3" alt="...">
                ...
                <div class="col-md-4 featured-responsive">
                    <div class="featured-place-wrap">
                        <a href="detail.html">
                            <img src="images/1200_20180831131707.png" class="img-fluid" alt="#">
                ...
                <div class="col-md-4 featured-responsive">
                    <div class="featured-place-wrap">
                        <a href="detail.html">
                            <img src="images/20180102-051047_U10834_M365289_a0da.jpg" class="img-fluid" alt="#">
