...
<c:forEach var="Restaurant_MenuVO" items="${list}">
		<div>
			...
			<span>${Restaurant_MenuVO.menu_no}</span>
            <span>${Restaurant_MenuVO.vendor_no}</span>
            <span>${Restaurant_MenuVO.menu_name}</span>
            <span>${Restaurant_MenuVO.menu_price}</span>
            <span>${Restaurant_MenuVO.menu_pic}</span>
            <span>${Restaurant_MenuVO.menu_stat}</span>
            <span>${Restaurant_MenuVO.menu_text}</span>
