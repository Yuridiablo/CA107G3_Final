...
INSERT INTO VENDOR VALUES ('V'||LPAD(to_char(VENDOR_SEQ.NEXTVAL), 6, '0'),'aaaaaa','111111','jkl8519653@gmail.com','81017799','02','244',
 '台北市','信義區','市府路45號台北101購物中心','056540248677','鼎泰豐',1,1,1,'0900','2000','1111100','68',NULL,NULL,'0','0','中式餐廳','經典台式小吃餐廳，排隊排到崩潰哦！');
 INSERT INTO VENDOR VALUES ('V'||LPAD(to_char(VENDOR_SEQ.NEXTVAL), 6, '0'),'bbbbbb','222222','rmv6574499@gmail.com','27239987','02','110',
'台北市','信義區','松壽路9號','15585812545','瓦城泰國料理 - 台北三越信義店',1,1,1,'0900','2000','1111100','20',NULL,NULL,'1','0','泰國餐廳','我們瓦城，白飯一碗45元，東西都辣的');
 INSERT INTO VENDOR VALUES ('V'||LPAD(to_char(VENDOR_SEQ.NEXTVAL), 6, '0'),'cccccc','333333','cth9614531@gmail.com','24652222','04','407',
 '台中市','西屯區','國安一路168號','13953979422','屋馬燒肉國安店',1,1,1,'1600','2300','1111111','40',NULL,NULL,'2','0','燒烤餐廳','全台最強燒烤就在我們家');
 ...
 '台中市','中區','中山路20號','18839540972','宮原眼科',99,99,99,'1300','1700','1111111','60',NULL,NULL,'3','0','甜點店','不是眼科的眼科，觀光客的最愛');
 ...
 '高雄市','前金區','新田路207號','15984315231','辣癮食尚麻辣火鍋',55,66,77,'1300','1700','0101010','44',NULL,NULL,'4','0','火鍋店','本店保證您吃完辣三天，不辣免費');
