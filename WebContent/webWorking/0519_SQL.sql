...
, V_NAME      VARCHAR2(200 BYTE)   NOT NULL 
...
INSERT INTO MEMBER VALUES ('M'||LPAD(to_char(member_seq.NEXTVAL), 6, '0'),'雷恩','f1234565','f1234565','M','f1@faucibusleoin.org','F172002313','0930779472','2',NULL,75899,'沒贏過');
INSERT INTO MEMBER VALUES ('M'||LPAD(to_char(member_seq.NEXTVAL), 6, '0'),'劉瑪琉','f1234566','f1234566','F','f2@faucibusleoin.org','F172002314','0930779473','2',NULL,15899,'紅頂商人');
INSERT INTO MEMBER VALUES ('M'||LPAD(to_char(member_seq.NEXTVAL), 6, '0'),'張雲','f1234567','f1234567','F','f3@faucibusleoin.org','F172002315','0930779474','2',NULL,13899,'維尼');
INSERT INTO MEMBER VALUES ('M'||LPAD(to_char(member_seq.NEXTVAL), 6, '0'),'珂玲','f1234568','f1234568','F','f4@faucibusleoin.org','F172002316','0930779475','3',NULL,12899,'做功德');
INSERT INTO MEMBER VALUES ('M'||LPAD(to_char(member_seq.NEXTVAL), 6, '0'),'十全大師','f1234569','f1234569','F','f5@faucibusleoin.org','F172002317','0930779476','2',NULL,55899,'十全老頭');
INSERT INTO MEMBER VALUES ('M'||LPAD(to_char(member_seq.NEXTVAL), 6, '0'),'小吳','f12345610','f12345610','M','f6@faucibusleoin.org','F172002318','0930779477','2',NULL,45899,'大衛海鮮');
INSERT INTO MEMBER VALUES ('M'||LPAD(to_char(member_seq.NEXTVAL), 6, '0'),'大吳','f12345611','f12345611','M','f7@faucibusleoin.org','F172082318','0930779478','2',NULL,44899,'吳神彼得');
INSERT INTO MEMBER VALUES ('M'||LPAD(to_char(member_seq.NEXTVAL), 6, '0'),'上海紹安','f12345612','f12345612','M','f8@faucibusleoin.org','F172007411','0930779479','2',NULL,15099,'紹安');
INSERT INTO MEMBER VALUES ('M'||LPAD(to_char(member_seq.NEXTVAL), 6, '0'),'面具工具人','f12345613','f12345613','M','f9@faucibusleoin.org','F172007412','0930779480','2',NULL,32009,'李嚴');
INSERT INTO MEMBER VALUES ('M'||LPAD(to_char(member_seq.NEXTVAL), 6, '0'),'武雄','f12345614','f12345614','M','f10@faucibusleoin.org','F172007413','0930779481','2',NULL,72009,'餃子兄弟');
INSERT INTO MEMBER VALUES ('M'||LPAD(to_char(member_seq.NEXTVAL), 6, '0'),'黑暗向恩','f12345615','f12345615','F','f11@faucibusleoin.org','F172007414','0930779482','2',NULL,62009,'向恩');
INSERT INTO MEMBER VALUES ('M'||LPAD(to_char(member_seq.NEXTVAL), 6, '0'),'美人阿飛','f12345616','f12345616','F','f12@faucibusleoin.org','F172007415','0930779483','2',NULL,62009,'阿飛');
INSERT INTO MEMBER VALUES ('M'||LPAD(to_char(member_seq.NEXTVAL), 6, '0'),'松重豐','f12345617','f12345617','M','f13@faucibusleoin.org','F172007416','0930779484','2',NULL,82009,'美食五郎');
INSERT INTO MEMBER VALUES ('M'||LPAD(to_char(member_seq.NEXTVAL), 6, '0'),'阿貝師傅','f12345618','f12345618','M','f14@faucibusleoin.org','F172007417','0930779485','2',NULL,80009,'阿貝師傅');
INSERT INTO MEMBER VALUES ('M'||LPAD(to_char(member_seq.NEXTVAL), 6, '0'),'魯夫','f12345619','f12345619','M','f15@faucibusleoin.org','F172007418','0930779486','1',NULL,60409,'橡皮人');
INSERT INTO MEMBER VALUES ('M'||LPAD(to_char(member_seq.NEXTVAL), 6, '0'),'綠戰士','f12345620','f12345620','M','f16@faucibusleoin.org','F172007419','0930779487','2',NULL,60409,'綠光赫林');
INSERT INTO MEMBER VALUES ('M'||LPAD(to_char(member_seq.NEXTVAL), 6, '0'),'羅根','f12345621','f12345621','M','f17@faucibusleoin.org','F172007420','0930779488','2',NULL,42409,'麵點老頭');
INSERT INTO MEMBER VALUES ('M'||LPAD(to_char(member_seq.NEXTVAL), 6, '0'),'大郭','f12345622','f12345622','M','f18@faucibusleoin.org','F172007421','0930779489','2',NULL,43409,'郭神');
INSERT INTO MEMBER VALUES ('M'||LPAD(to_char(member_seq.NEXTVAL), 6, '0'),'黃老鼠','f12345623','f12345623','M','f19@faucibusleoin.org','F172007422','0930779490','2',NULL,13409,'皮卡丘');
...
'台北市','信義區','松壽路9號','2545','瓦城泰國料理 - 台北三越信義店',1,1,1,'0900','2000','1111100','20',Null,Null,'1',60,'泰國餐廳','我們瓦城，白飯一碗45元，東西都辣的');
 ...
 '桃園市','大園區','沙崙里漁港路451巷25號','50005','呷嘛是簡單的',80,75,0,'1000','2100','0101010','91',Null,Null,'1',60,'吃到飽','要什麼給什麼，呷嘛是簡單的！');
...
INSERT INTO RESTAURANT_MENU VALUES ('RM'||LPAD(to_char(RESTAURANT_MENU_SEQ.NEXTVAL), 8, '0')
    ,'V000002','豆腐三重奏','900',null,1,'那真是太諷刺了紹安，你離開你師傅繞了一大圈，最後到達的境界，竟然是你不想學的，你師傅的料理，所以說呢，人心最終還是要回到故鄉來的');
INSERT INTO RESTAURANT_MENU VALUES ('RM'||LPAD(to_char(RESTAURANT_MENU_SEQ.NEXTVAL), 8, '0')
    ,'V000003','法式烘蛋','10',null,1,'雞蛋家常菜，佛心便宜賣');
INSERT INTO RESTAURANT_MENU VALUES ('RM'||LPAD(to_char(RESTAURANT_MENU_SEQ.NEXTVAL), 8, '0')
    ,'V000004','雖敗遊龍鍋貼','300',null,1,'這位先生叫武雄吧，你有沒有想過品嚐美食的人，到底真正在追求什麼呢,那時候我對你們說要再來一盤，並不是因為肚子餓才說的。');
INSERT INTO RESTAURANT_MENU VALUES ('RM'||LPAD(to_char(RESTAURANT_MENU_SEQ.NEXTVAL), 8, '0')
    ,'V000005','特級廚師小當家豪華餐','487',null,1,'平淡的創意卻企圖以華麗表演來掩飾，你應該感到慚愧。貧乏的想像力和技巧的沉迷，都是廚師的致命傷。你還是回去磨練21小時再來吧');
INSERT INTO RESTAURANT_MENU VALUES ('RM'||LPAD(to_char(RESTAURANT_MENU_SEQ.NEXTVAL), 8, '0')
    ,'V000005','鶴麟綠咖哩戴綠帽套餐','99',null,1,'平淡的咖哩料理卻隱藏著綠光,淡淡的哀傷讓我越吃越哀傷');
INSERT INTO RESTAURANT_MENU VALUES ('RM'||LPAD(to_char(RESTAURANT_MENU_SEQ.NEXTVAL), 8, '0')
    ,'V000005','聖甲蟲500吃到飽','500',null,1,'500吃到飽500吃到好,想要我變好,等到你變老');
INSERT INTO RESTAURANT_MENU VALUES ('RM'||LPAD(to_char(RESTAURANT_MENU_SEQ.NEXTVAL), 8, '0')
    ,'V000005','含粉特級冷凍包子','689',null,1,'包子還是冷凍的好吃,高雄發大財');
INSERT INTO RESTAURANT_MENU VALUES ('RM'||LPAD(to_char(RESTAURANT_MENU_SEQ.NEXTVAL), 8, '0')
    ,'V000005','老媽媽芋園','945',null,1,'老媽媽芋園有老媽媽的味道,雖然店員比芋園好吃就是了');
INSERT INTO RESTAURANT_MENU VALUES ('RM'||LPAD(to_char(RESTAURANT_MENU_SEQ.NEXTVAL), 8, '0')
    ,'V000001','小紅牛腿排','69',null,1,'牛排雖好吃,腿排位更佳,媽媽很不錯,女兒才是棒');
INSERT INTO RESTAURANT_MENU VALUES ('RM'||LPAD(to_char(RESTAURANT_MENU_SEQ.NEXTVAL), 8, '0')
    ,'V000001','排骨炒飯','200',null,1,'不就排骨，不就炒飯，加在一起，當你盤子');
INSERT INTO RESTAURANT_MENU VALUES ('RM'||LPAD(to_char(RESTAURANT_MENU_SEQ.NEXTVAL), 8, '0')
    ,'V000001','鮮蝦蒸餃','1000',null,1,'本店唯一正常的東西，正常的蝦子，正常的餃子，唯一不正常的是價格');
INSERT INTO RESTAURANT_MENU VALUES ('RM'||LPAD(to_char(RESTAURANT_MENU_SEQ.NEXTVAL), 8, '0')
...
INSERT INTO RESTAURANT_MENU VALUES ('RM'||LPAD(to_char(RESTAURANT_MENU_SEQ.NEXTVAL), 8, '0')
    ,'V000011','吳家臭豆腐','380',null,1,'談到臭豆腐,我們吳家使用獨家酵母，使用甲蟲,地瓜,還有光合作用的深層發酵,吃完絕對變成臭嘴哥');
INSERT INTO RESTAURANT_MENU VALUES ('RM'||LPAD(to_char(RESTAURANT_MENU_SEQ.NEXTVAL), 8, '0')
    ,'V000011','吳哥戀戀不捨','500',null,1,'在夏天的午後,來一碗綿綿冰,周圍淋上滿滿的戀奶,讓你依依不捨,戀上一個人');
INSERT INTO RESTAURANT_MENU VALUES ('RM'||LPAD(to_char(RESTAURANT_MENU_SEQ.NEXTVAL), 8, '0')
    ,'V000021','波士頓大龍蝦','10000',null,1,'波士頓，我們有龍蝦了');
INSERT INTO RESTAURANT_MENU VALUES ('RM'||LPAD(to_char(RESTAURANT_MENU_SEQ.NEXTVAL), 8, '0')
    ,'V000021','焗烤波士頓龍蝦','8000',null,1,'聽說老闆很熱心，會當場到海裡抓給你');
INSERT INTO RESTAURANT_MENU VALUES ('RM'||LPAD(to_char(RESTAURANT_MENU_SEQ.NEXTVAL), 8, '0')
    ,'V000021','波士頓超級大龍蝦','20000',null,1,'萬中選一，絕無僅有，重達3.141592654公斤');
...
INSERT INTO RESERVATION_TIME VALUES ('RT'||LPAD(to_char(RESERVATION_T_SEQ.NEXTVAL), 8, '0'),'V000021',TO_CHAR(1500,'0000'));
INSERT INTO RESERVATION_TIME VALUES ('RT'||LPAD(to_char(RESERVATION_T_SEQ.NEXTVAL), 8, '0'),'V000021',TO_CHAR(1600,'0000'));
...
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('20-5月-19','DD-MON-RR'),'1300',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('20-5月-19','DD-MON-RR'),'1400',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('20-5月-19','DD-MON-RR'),'1500',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('20-5月-19','DD-MON-RR'),'1600',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('20-5月-19','DD-MON-RR'),'1700',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('20-5月-19','DD-MON-RR'),'1800',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('20-5月-19','DD-MON-RR'),'1900',5,5,5,5,5,4,4,4,4,4);



INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('21-5月-19','DD-MON-RR'),'1300',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('21-5月-19','DD-MON-RR'),'1400',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('21-5月-19','DD-MON-RR'),'1500',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('21-5月-19','DD-MON-RR'),'1600',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('21-5月-19','DD-MON-RR'),'1700',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('21-5月-19','DD-MON-RR'),'1800',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('21-5月-19','DD-MON-RR'),'1900',5,5,5,5,5,4,4,4,4,4);


-- INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('22-5月-19','DD-MON-RR'),'1300',5,5,5,5,5,4,4,4,4,4);
-- INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('22-5月-19','DD-MON-RR'),'1400',5,5,5,5,5,4,4,4,4,4);
-- INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('22-5月-19','DD-MON-RR'),'1500',5,5,5,5,5,4,4,4,4,4);
-- INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('22-5月-19','DD-MON-RR'),'1600',5,5,5,5,5,4,4,4,4,4);
-- INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('22-5月-19','DD-MON-RR'),'1700',5,5,5,5,5,4,4,4,4,4);
-- INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('22-5月-19','DD-MON-RR'),'1800',5,5,5,5,5,4,4,4,4,4);
-- INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('22-5月-19','DD-MON-RR'),'1900',5,5,5,5,5,4,4,4,4,4);

INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('23-5月-19','DD-MON-RR'),'1300',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('23-5月-19','DD-MON-RR'),'1400',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('23-5月-19','DD-MON-RR'),'1500',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('23-5月-19','DD-MON-RR'),'1600',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('23-5月-19','DD-MON-RR'),'1700',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('23-5月-19','DD-MON-RR'),'1800',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('23-5月-19','DD-MON-RR'),'1900',5,5,5,5,5,4,4,4,4,4);

INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('24-5月-19','DD-MON-RR'),'1300',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('24-5月-19','DD-MON-RR'),'1400',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('24-5月-19','DD-MON-RR'),'1500',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('24-5月-19','DD-MON-RR'),'1600',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('24-5月-19','DD-MON-RR'),'1700',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('24-5月-19','DD-MON-RR'),'1800',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('24-5月-19','DD-MON-RR'),'1900',5,5,5,5,5,4,4,4,4,4);

INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('25-5月-19','DD-MON-RR'),'1300',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('25-5月-19','DD-MON-RR'),'1400',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('25-5月-19','DD-MON-RR'),'1500',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('25-5月-19','DD-MON-RR'),'1600',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('25-5月-19','DD-MON-RR'),'1700',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('25-5月-19','DD-MON-RR'),'1800',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('25-5月-19','DD-MON-RR'),'1900',5,5,5,5,5,4,4,4,4,4);

INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('26-5月-19','DD-MON-RR'),'1300',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('26-5月-19','DD-MON-RR'),'1400',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('26-5月-19','DD-MON-RR'),'1500',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('26-5月-19','DD-MON-RR'),'1600',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('26-5月-19','DD-MON-RR'),'1700',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('26-5月-19','DD-MON-RR'),'1800',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('26-5月-19','DD-MON-RR'),'1900',5,5,5,5,5,4,4,4,4,4);

INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('27-5月-19','DD-MON-RR'),'1300',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('27-5月-19','DD-MON-RR'),'1400',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('27-5月-19','DD-MON-RR'),'1500',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('27-5月-19','DD-MON-RR'),'1600',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('27-5月-19','DD-MON-RR'),'1700',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('27-5月-19','DD-MON-RR'),'1800',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('27-5月-19','DD-MON-RR'),'1900',5,5,5,5,5,4,4,4,4,4);

INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('28-5月-19','DD-MON-RR'),'1300',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('28-5月-19','DD-MON-RR'),'1400',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('28-5月-19','DD-MON-RR'),'1500',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('28-5月-19','DD-MON-RR'),'1600',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('28-5月-19','DD-MON-RR'),'1700',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('28-5月-19','DD-MON-RR'),'1800',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('28-5月-19','DD-MON-RR'),'1900',5,5,5,5,5,4,4,4,4,4);

-- INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('29-5月-19','DD-MON-RR'),'1300',5,5,5,5,5,4,4,4,4,4);
-- INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('29-5月-19','DD-MON-RR'),'1400',5,5,5,5,5,4,4,4,4,4);
-- INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('29-5月-19','DD-MON-RR'),'1500',5,5,5,5,5,4,4,4,4,4);
-- INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('29-5月-19','DD-MON-RR'),'1600',5,5,5,5,5,4,4,4,4,4);
-- INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('29-5月-19','DD-MON-RR'),'1700',5,5,5,5,5,4,4,4,4,4);
-- INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('29-5月-19','DD-MON-RR'),'1800',5,5,5,5,5,4,4,4,4,4);
-- INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('29-5月-19','DD-MON-RR'),'1900',5,5,5,5,5,4,4,4,4,4);

INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('30-5月-19','DD-MON-RR'),'1300',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('30-5月-19','DD-MON-RR'),'1400',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('30-5月-19','DD-MON-RR'),'1500',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('30-5月-19','DD-MON-RR'),'1600',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('30-5月-19','DD-MON-RR'),'1700',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('30-5月-19','DD-MON-RR'),'1800',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('30-5月-19','DD-MON-RR'),'1900',5,5,5,5,5,4,4,4,4,4);

INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('31-5月-19','DD-MON-RR'),'1300',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('31-5月-19','DD-MON-RR'),'1400',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('31-5月-19','DD-MON-RR'),'1510',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('31-5月-19','DD-MON-RR'),'1600',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('31-5月-19','DD-MON-RR'),'1700',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('31-5月-19','DD-MON-RR'),'1800',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('31-5月-19','DD-MON-RR'),'1900',5,5,5,5,5,4,4,4,4,4);

INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('01-6月-19','DD-MON-RR'),'1300',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('01-6月-19','DD-MON-RR'),'1400',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('01-6月-19','DD-MON-RR'),'1500',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('01-6月-19','DD-MON-RR'),'1600',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('01-6月-19','DD-MON-RR'),'1700',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('01-6月-19','DD-MON-RR'),'1800',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('01-6月-19','DD-MON-RR'),'1900',5,5,5,5,5,4,4,4,4,4);

INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('02-6月-19','DD-MON-RR'),'1300',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('02-6月-19','DD-MON-RR'),'1400',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('02-6月-19','DD-MON-RR'),'1500',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('02-6月-19','DD-MON-RR'),'1600',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('02-6月-19','DD-MON-RR'),'1700',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('02-6月-19','DD-MON-RR'),'1800',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('02-6月-19','DD-MON-RR'),'1900',5,5,5,5,5,4,4,4,4,4);

INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('03-6月-19','DD-MON-RR'),'1300',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('03-6月-19','DD-MON-RR'),'1400',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('03-6月-19','DD-MON-RR'),'1500',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('03-6月-19','DD-MON-RR'),'1600',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('03-6月-19','DD-MON-RR'),'1700',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('03-6月-19','DD-MON-RR'),'1800',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('03-6月-19','DD-MON-RR'),'1900',5,5,5,5,5,4,4,4,4,4);


INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('04-6月-19','DD-MON-RR'),'1300',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('04-6月-19','DD-MON-RR'),'1400',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('04-6月-19','DD-MON-RR'),'1500',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('04-6月-19','DD-MON-RR'),'1600',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('04-6月-19','DD-MON-RR'),'1700',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('04-6月-19','DD-MON-RR'),'1800',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('04-6月-19','DD-MON-RR'),'1900',5,5,5,5,5,4,4,4,4,4);


INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('05-6月-19','DD-MON-RR'),'1300',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('05-6月-19','DD-MON-RR'),'1400',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('05-6月-19','DD-MON-RR'),'1500',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('05-6月-19','DD-MON-RR'),'1600',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('05-6月-19','DD-MON-RR'),'1700',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('05-6月-19','DD-MON-RR'),'1800',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('05-6月-19','DD-MON-RR'),'1900',5,5,5,5,5,4,4,4,4,4);


INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('06-6月-19','DD-MON-RR'),'1300',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('06-6月-19','DD-MON-RR'),'1400',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('06-6月-19','DD-MON-RR'),'1500',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('06-6月-19','DD-MON-RR'),'1600',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('06-6月-19','DD-MON-RR'),'1700',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('06-6月-19','DD-MON-RR'),'1800',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('06-6月-19','DD-MON-RR'),'1900',5,5,5,5,5,4,4,4,4,4);


INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('07-6月-19','DD-MON-RR'),'1300',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('07-6月-19','DD-MON-RR'),'1400',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('07-6月-19','DD-MON-RR'),'1500',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('07-6月-19','DD-MON-RR'),'1600',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('07-6月-19','DD-MON-RR'),'1700',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('07-6月-19','DD-MON-RR'),'1800',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('07-6月-19','DD-MON-RR'),'1900',5,5,5,5,5,4,4,4,4,4);


INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('08-6月-19','DD-MON-RR'),'1300',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('08-6月-19','DD-MON-RR'),'1400',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('08-6月-19','DD-MON-RR'),'1500',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('08-6月-19','DD-MON-RR'),'1600',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('08-6月-19','DD-MON-RR'),'1700',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('08-6月-19','DD-MON-RR'),'1800',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('08-6月-19','DD-MON-RR'),'1900',5,5,5,5,5,4,4,4,4,4);


INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('09-6月-19','DD-MON-RR'),'1300',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('09-6月-19','DD-MON-RR'),'1400',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('09-6月-19','DD-MON-RR'),'1500',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('09-6月-19','DD-MON-RR'),'1600',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('09-6月-19','DD-MON-RR'),'1700',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('09-6月-19','DD-MON-RR'),'1800',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('09-6月-19','DD-MON-RR'),'1900',5,5,5,5,5,4,4,4,4,4);


INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('10-6月-19','DD-MON-RR'),'1300',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('10-6月-19','DD-MON-RR'),'1400',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('10-6月-19','DD-MON-RR'),'1500',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('10-6月-19','DD-MON-RR'),'1600',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('10-6月-19','DD-MON-RR'),'1700',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('10-6月-19','DD-MON-RR'),'1800',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('10-6月-19','DD-MON-RR'),'1900',5,5,5,5,5,4,4,4,4,4);


INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('11-6月-19','DD-MON-RR'),'1300',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('11-6月-19','DD-MON-RR'),'1400',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('11-6月-19','DD-MON-RR'),'1500',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('11-6月-19','DD-MON-RR'),'1600',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('11-6月-19','DD-MON-RR'),'1700',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('11-6月-19','DD-MON-RR'),'1800',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('11-6月-19','DD-MON-RR'),'1900',5,5,5,5,5,4,4,4,4,4);


INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('12-6月-19','DD-MON-RR'),'1300',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('12-6月-19','DD-MON-RR'),'1400',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('12-6月-19','DD-MON-RR'),'1500',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('12-6月-19','DD-MON-RR'),'1600',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('12-6月-19','DD-MON-RR'),'1700',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('12-6月-19','DD-MON-RR'),'1800',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('12-6月-19','DD-MON-RR'),'1900',5,5,5,5,5,4,4,4,4,4);


INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('13-6月-19','DD-MON-RR'),'1300',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('13-6月-19','DD-MON-RR'),'1400',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('13-6月-19','DD-MON-RR'),'1500',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('13-6月-19','DD-MON-RR'),'1600',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('13-6月-19','DD-MON-RR'),'1700',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('13-6月-19','DD-MON-RR'),'1800',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('13-6月-19','DD-MON-RR'),'1900',5,5,5,5,5,4,4,4,4,4);


INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('14-6月-19','DD-MON-RR'),'1300',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('14-6月-19','DD-MON-RR'),'1400',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('14-6月-19','DD-MON-RR'),'1500',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('14-6月-19','DD-MON-RR'),'1600',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('14-6月-19','DD-MON-RR'),'1700',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('14-6月-19','DD-MON-RR'),'1800',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('14-6月-19','DD-MON-RR'),'1900',5,5,5,5,5,4,4,4,4,4);


INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('15-6月-19','DD-MON-RR'),'1300',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('15-6月-19','DD-MON-RR'),'1400',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('15-6月-19','DD-MON-RR'),'1500',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('15-6月-19','DD-MON-RR'),'1600',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('15-6月-19','DD-MON-RR'),'1700',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('15-6月-19','DD-MON-RR'),'1800',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('15-6月-19','DD-MON-RR'),'1900',5,5,5,5,5,4,4,4,4,4);


INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('16-6月-19','DD-MON-RR'),'1300',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('16-6月-19','DD-MON-RR'),'1400',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('16-6月-19','DD-MON-RR'),'1500',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('16-6月-19','DD-MON-RR'),'1600',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('16-6月-19','DD-MON-RR'),'1700',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('16-6月-19','DD-MON-RR'),'1800',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('16-6月-19','DD-MON-RR'),'1900',5,5,5,5,5,4,4,4,4,4);


INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('17-6月-19','DD-MON-RR'),'1300',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('17-6月-19','DD-MON-RR'),'1400',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('17-6月-19','DD-MON-RR'),'1500',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('17-6月-19','DD-MON-RR'),'1600',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('17-6月-19','DD-MON-RR'),'1700',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('17-6月-19','DD-MON-RR'),'1800',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('17-6月-19','DD-MON-RR'),'1900',5,5,5,5,5,4,4,4,4,4);


INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('18-6月-19','DD-MON-RR'),'1300',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('18-6月-19','DD-MON-RR'),'1400',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('18-6月-19','DD-MON-RR'),'1500',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('18-6月-19','DD-MON-RR'),'1600',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('18-6月-19','DD-MON-RR'),'1700',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('18-6月-19','DD-MON-RR'),'1800',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('18-6月-19','DD-MON-RR'),'1900',5,5,5,5,5,4,4,4,4,4);


INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('19-6月-19','DD-MON-RR'),'1300',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('19-6月-19','DD-MON-RR'),'1400',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('19-6月-19','DD-MON-RR'),'1500',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('19-6月-19','DD-MON-RR'),'1600',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('19-6月-19','DD-MON-RR'),'1700',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('19-6月-19','DD-MON-RR'),'1800',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('19-6月-19','DD-MON-RR'),'1900',5,5,5,5,5,4,4,4,4,4);


INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('20-6月-19','DD-MON-RR'),'1300',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('20-6月-19','DD-MON-RR'),'1400',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('20-6月-19','DD-MON-RR'),'1500',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('20-6月-19','DD-MON-RR'),'1600',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('20-6月-19','DD-MON-RR'),'1700',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('20-6月-19','DD-MON-RR'),'1800',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('20-6月-19','DD-MON-RR'),'1900',5,5,5,5,5,4,4,4,4,4);


INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('21-6月-19','DD-MON-RR'),'1300',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('21-6月-19','DD-MON-RR'),'1400',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('21-6月-19','DD-MON-RR'),'1500',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('21-6月-19','DD-MON-RR'),'1600',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('21-6月-19','DD-MON-RR'),'1700',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('21-6月-19','DD-MON-RR'),'1800',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('21-6月-19','DD-MON-RR'),'1900',5,5,5,5,5,4,4,4,4,4);


INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('22-6月-19','DD-MON-RR'),'1300',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('22-6月-19','DD-MON-RR'),'1400',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('22-6月-19','DD-MON-RR'),'1500',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('22-6月-19','DD-MON-RR'),'1600',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('22-6月-19','DD-MON-RR'),'1700',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('22-6月-19','DD-MON-RR'),'1800',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('22-6月-19','DD-MON-RR'),'1900',5,5,5,5,5,4,4,4,4,4);


INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('23-6月-19','DD-MON-RR'),'1300',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('23-6月-19','DD-MON-RR'),'1400',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('23-6月-19','DD-MON-RR'),'1500',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('23-6月-19','DD-MON-RR'),'1600',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('23-6月-19','DD-MON-RR'),'1700',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('23-6月-19','DD-MON-RR'),'1800',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('23-6月-19','DD-MON-RR'),'1900',5,5,5,5,5,4,4,4,4,4);


INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('24-6月-19','DD-MON-RR'),'1300',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('24-6月-19','DD-MON-RR'),'1400',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('24-6月-19','DD-MON-RR'),'1500',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('24-6月-19','DD-MON-RR'),'1600',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('24-6月-19','DD-MON-RR'),'1700',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('24-6月-19','DD-MON-RR'),'1800',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('24-6月-19','DD-MON-RR'),'1900',5,5,5,5,5,4,4,4,4,4);

INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('25-6月-20','DD-MON-RR'),'1300',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('25-6月-20','DD-MON-RR'),'1400',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('25-6月-20','DD-MON-RR'),'1500',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('25-6月-20','DD-MON-RR'),'1600',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('25-6月-20','DD-MON-RR'),'1700',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('25-6月-20','DD-MON-RR'),'1800',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('25-6月-20','DD-MON-RR'),'1900',5,5,5,5,5,4,4,4,4,4);

INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('26-6月-19','DD-MON-RR'),'1300',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('26-6月-19','DD-MON-RR'),'1400',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('26-6月-19','DD-MON-RR'),'1500',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('26-6月-19','DD-MON-RR'),'1600',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('26-6月-19','DD-MON-RR'),'1700',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('26-6月-19','DD-MON-RR'),'1800',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('26-6月-19','DD-MON-RR'),'1900',5,5,5,5,5,4,4,4,4,4);

INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('27-6月-19','DD-MON-RR'),'1300',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('27-6月-19','DD-MON-RR'),'1400',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('27-6月-19','DD-MON-RR'),'1500',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('27-6月-19','DD-MON-RR'),'1600',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('27-6月-19','DD-MON-RR'),'1700',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('27-6月-19','DD-MON-RR'),'1800',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('27-6月-19','DD-MON-RR'),'1900',5,5,5,5,5,4,4,4,4,4);

INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('28-6月-19','DD-MON-RR'),'1300',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('28-6月-19','DD-MON-RR'),'1400',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('28-6月-19','DD-MON-RR'),'1500',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('28-6月-19','DD-MON-RR'),'1600',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('28-6月-19','DD-MON-RR'),'1700',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('28-6月-19','DD-MON-RR'),'1800',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('28-6月-19','DD-MON-RR'),'1900',5,5,5,5,5,4,4,4,4,4);

INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('29-6月-19','DD-MON-RR'),'1300',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('29-6月-19','DD-MON-RR'),'1400',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('29-6月-19','DD-MON-RR'),'1500',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('29-6月-19','DD-MON-RR'),'1600',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('29-6月-19','DD-MON-RR'),'1700',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('29-6月-19','DD-MON-RR'),'1800',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('29-6月-19','DD-MON-RR'),'1900',5,5,5,5,5,4,4,4,4,4);

INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('30-6月-19','DD-MON-RR'),'1300',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('30-6月-19','DD-MON-RR'),'1400',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('30-6月-19','DD-MON-RR'),'1500',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('30-6月-19','DD-MON-RR'),'1600',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('30-6月-19','DD-MON-RR'),'1700',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('30-6月-19','DD-MON-RR'),'1800',5,5,5,5,5,4,4,4,4,4);
INSERT INTO RESERVATION_TABLE_ORDERED VALUES ('RTO'||LPAD(to_char(RESERVATION_TABLE_ORDERED_SEQ.NEXTVAL), 7, '0'),'V000021',to_date('30-6月-19','DD-MON-RR'),'1900',5,5,5,5,5,4,4,4,4,4);
